IETF and IEEE protocols for low-power power and lossy networks target the consumer IoT, where security requirements are relaxed. Industrial and medical applications, however, require more secure protocols. For such applications, this repo implements the following security-enhanced protocol stack:
